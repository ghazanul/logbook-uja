                            ...
                            @foreach ($users as $user)
                                <tr class="border-b border-[#047857] p-5">
                                    ...
                                    <td class="flex justify-center py-2">
                                        ...
                                        <a href="user/{{ $user->id }}/edit-password" title="Edit Password">
                                            <img src="{{ asset('images/padlock.png') }}"
                                                class="bg-[#047857] p-1 me-3 rounded " width="40" height="40"
                                                alt="edit">
                                        </a>
                                        <form onclick="hapusUser({{ $user->id }})">
        ...
        function hapusUser(id) {
            ...
            swalWithBootstrapButtons.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    const response = await fetch(`/${season}/user/${id}`, {
                        method: 'DELETE',
                        headers: {
                    ...
                    window.location.href = `/${season}/user?msg=${encodeURIComponent(responseJson.message)}`; // Ganti sesuai kebutuhanmu
                }
            })
        }
    </script>
